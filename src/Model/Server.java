        ...
        Thread thread = new Thread()
        {
            public void run()
            {
                ...
                { // socket exception
                    ...
                    ChatController.receiveMessages("START");
                    for (; ; ) // main loop
                    {
                        ...
                        ChatController.receiveMessages("Request Room Id Is " + new String(tmp, Charset.forName("UTF-8")));
                        ...
                        ChatController.receiveMessages("The Room " + new String(tmp, Charset.forName("UTF-8")) + " Ip Is " + ip);
                        socket.send(sendMes);
                    }
                } catch (Exception e)
                {
